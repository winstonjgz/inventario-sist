...
<div class="container pb-6 pt-6">
    ...
    if (isset($_POST['modulo_buscador']) && $_POST['modulo_buscador'] == "producto") {
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="field is-grouped">
                        <p class="control is-expanded">
                            <input type="text" class="input is-rounded" name="txt_busqueda" placeholder="Buscar por nombre, producto o codigo" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚÑñ]{1,30}" maxlength="30">
                        </p>
                        <p class="control">
        ...
        <div class="columns">
            <div class="column">
                <form class="has-text-centered mt-6 mb-6" method="post" autocomplete="off">
                    <input type="hidden" name="modulo_buscador" value="producto">
                    <input type="hidden" name="eliminar_buscar" value="producto">
